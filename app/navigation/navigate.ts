...
const trackingWorkedInfo = (navigation) => (props = {}) => {
  navigation.replace("TrackingWorkInfo", props);
};


const navigate = (navigation) => ({
  goBack: navigation.goBack,
  signOut: navigateOneTime(signOut(navigation)),
  ...
  trackingScreen: navigateOneTime(trackingScreen(navigation)),
  trackingWorkInfoScreen: navigateOneTime(trackingWorkedInfo(navigation)),
